...
/**
 * className: ${table_name?cap_first}Test <BR>
 * description: ${table_annotation}测试类<BR>
 * remark: <BR>
 * author: ${author} <BR>
 * createDate: ${date} <BR>
 */
public class ${table_name?cap_first}Test extends BaseTest {
    ...
    public void saveTest() throws Exception{
        ...
        Assert.assertNotNull(${table_name?uncap_first}Dao.findById(id).get());
    }
